 ...
 * @var \App\Model\Entity\Pothole[]|\Cake\Collection\CollectionInterface $potholes
 */
?>
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        <li class="heading"><?= __('Actions') ?></li>
        <li><?= $this->Html->link(__('New Pothole'), ['action' => 'add']) ?></li>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $pothole->has('user') ? $this->Html->link($pothole->user->name, ['controller' => 'Users', 'action' => 'view', $pothole->user->id]) : '' ?></td>
